  ...
  return (
    <article className="group flex h-full flex-col rounded-2xl border border-slate-200 bg-white p-2.5 shadow-sm transition hover:-translate-y-0.5 hover:border-brand-200 hover:shadow-lg">
        ...
        <div className="mt-auto pt-2">
          <Link href={`/jobs/${job.id}`} className="inline-flex items-center justify-center rounded-full bg-brand-600 px-3 py-1 text-xs font-semibold text-white transition group-hover:bg-brand-700">
            View Details
          </Link>
        </div>
    </article>
